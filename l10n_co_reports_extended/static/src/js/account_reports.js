...
odoo.define('account_reports_consolcargo.account_report_consol', function (require) {
  'use strict';
  
  var core = require('web.core');
  console.log("Inicia el render");
  var datepicker = require('web.datepicker');
  var accountReportsWidgetExtendedd = require('account_reports.account_report');
  ...
  accountReportsWidgetExtendedd.include({
    custom_events: {
      'value_changed': function(ev) {
           ...
           self.report_options.partner_networks = ev.data.partner_networks;
    ...
    render_searchview_buttons: function () {
      ...
      if (this.report_options.partner) {
          if (!this.M2MFilters) {
              ...
              if ('partner_networks' in this.report_options) {
                  fields['partner_networks'] = {
                    label: _t('Networks'),
                    modelName: 'res.partner.network',
                    value: this.report_options.partner_networks.map(Number),
                  }
            };
              if (!_.isEmpty(fields)) {
